...
2. __Formulario de registro de usuarios__:
   ...
   Este lo guardaremos en `/todoapp/templates/register_user.html` y llevará lo siguiente: 
   ```html
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
1. [Buttons](https://getbootstrap.com/docs/5.2/components/buttons/#examples)
2. [Containers](https://getbootstrap.com/docs/5.2/layout/containers/#default-container)
3. [Form Grid](https://getbootstrap.com/docs/5.2/layout/containers/#default-container)
4. [Shadows](https://getbootstrap.com/docs/5.2/utilities/shadows/#examples)
